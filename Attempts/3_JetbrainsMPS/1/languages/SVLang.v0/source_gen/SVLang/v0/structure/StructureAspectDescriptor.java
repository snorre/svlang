...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("SVLang.v0.structure.CodeFile").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"namespace", "imports", "main"}, new boolean[]{false, true, false}).create();
      case 1:
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"SVLang.v0.structure.CodeFile", "SVLang.v0.structure.Codeline", "SVLang.v0.structure.Import", "SVLang.v0.structure.Main", "SVLang.v0.structure.Namespace"};
}
